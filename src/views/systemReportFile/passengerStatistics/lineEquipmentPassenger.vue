      ...
      getData() {
        ...
        _t.$refs.formData.validate(val => {
          if (val) {
            ...
            if (_t.formItem.lines !== '' && time && _t.formItem.type !== '') {
              // 嵌入网页是否显示
              _t.isShow = true;
              ...
              _t.formIframeSrc = _t.$apiForms +'/tbIetp-reportForm/ReportEmitter?rpt=/1105线路分设备客流统计报表.brt&params=p_device_type='+_t.formItem.type+';p_line_id='+ _t.formItem.lines.substr(0,2) + ';p_stop='+startData.toString()+ ';p_start='+ stopData.toString()+ ';&grabheight=true&fitwidth=true';
            }
          }
        });
      },
