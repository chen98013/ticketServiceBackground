      ...
      getData() {
        ...
        _t.$refs.formData.validate((val) => {
          if (val) {
            ...
            if (_t.formItem.lines !== ''&& init && _t.formItem.type !== '' && _t.formItem.station !== '') {
              // 嵌入网页是否显示
              _t.isShow = true;
              ...
              _t.formIframeSrc = _t.$apiForms +'/tbIetp-reportForm/ReportEmitter?rpt=/1103车站分设备客流统计报表.brt&params=p_device_type=' + _t.formItem.type + ';p_station_id=' + _t.formItem.station + ';p_stop=' + startData + ';p_start=' + stopData + ';&grabheight=true&fitwidth=true';
            }
          }
        });
      },
