        ...
        _t.$refs.formData.validate(val => {
          if (val) {
            ...
            if (1) {
              ...
              _t.formIframeSrc = _t.$apiForms +'/tbIetp-reportForm/ReportEmitter?rpt=/4104进出闸客流分时段统计表.brt&params=p_station_id='+ _t.formItem.station +';p_interval=' + _t.formItem.interval + ';p_start=' + stopData + ';&grabheight=true&fitwidth=true';
            }
          }
        });
      },
