      ...
      _t.$refs.formData.validate((val) => {
        if (val) {
          ...
          if (1) {
            // 嵌入网页是否显示
            _t.isShow = true;
            _t.formIframeSrc = _t.$apiForms +'/tbIetp-reportForm/ReportEmitter?rpt=/票务售票员结算汇总统计表.brt&params=pstation=' + _t.formItem.station + ';time2=' + _t.formItem.dateTime[1] + ';time1=' + _t.formItem.dateTime[0] + ';&grabheight=true&fitwidth=true';
          }
        }
      });
    },
