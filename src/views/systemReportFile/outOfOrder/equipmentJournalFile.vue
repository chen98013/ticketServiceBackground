        ...
        _t.$refs.formData.validate(val => {
          if (val) {
            ...
            if (_t.formItem.lines !== '' && _t.formItem.dateTime.length !== 0 && _t.formItem.type !== '') {
              ...
              _t.formIframeSrc =_t.$apiForms +'/tbIetp-reportForm/ReportEmitter?rpt=/5101设备故障明细报表.brt&params=p_line_id='+ _t.formItem.lines.substr(0,2) + ';p_device_type='+_t.formItem.type+';p_start='+stopData+';&grabheight=true&fitwidth=true';
            }
          }
        });
      },
