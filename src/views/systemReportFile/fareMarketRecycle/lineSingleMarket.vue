      ...
      getData() {
        ...
        _t.$refs.formData.validate(val => {
          if (val) {
            ...
            if (_t.formItem.type !== '' && _t.formItem.lines !== '' && time) {
              // 嵌入网页是否显示
              _t.isShow = true;
              ...
              _t.formIframeSrc =_t.$apiForms +'/tbIetp-reportForm/ReportEmitter?rpt=/3103线路单程票销售统计报表.brt&params=p_device_type='+_t.formItem.type+';p_line_id='+ _t.formItem.lines.substr(0,2) + ';p_stop='+ startData + ';p_start=' + stopData + ';&grabheight=true&fitwidth=true';
