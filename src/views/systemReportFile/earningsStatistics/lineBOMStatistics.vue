        ...
        _t.$refs.formData.validate(val => {
          if (val) {
            ...
            if (_t.formItem.lines !== '' && time) {
              ...
              _t.formIframeSrc = _t.$apiForms +'/tbIetp-reportForm/ReportEmitter?rpt=/2106线路BOM收益性汇总表.brt&params=p_line_id='+_t.formItem.lines.substr(0,2)+';p_stop=' + startData + ';p_start=' + stopData + ';&grabheight=true&fitwidth=true';
            }
          }
        });
      },
