      ...
      getData() {
        ...
        _t.$refs.formData.validate(val => {
          if (val) {
            ...
            if (_t.formItem.station !== '' && _t.formItem.lines !== '' && time) {
              // 嵌入网页是否显示
              _t.isShow = true;
              ...
              _t.formIframeSrc = _t.$apiForms +'/tbIetp-reportForm/ReportEmitter?rpt=/2102车站分设备消费统计报表.brt&params=p_line_id=' +_t.formItem.lines.substr(0,2) +';p_station_id='+_t.formItem.station+';p_stop=' + startData + ';p_start=' + stopData + ';&grabheight=true&fitwidth=true';
            }
          }
        });
