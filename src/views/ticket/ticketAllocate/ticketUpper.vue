    ...
    <div class="formBox-top">
      ...
      <el-form :model="formItem" label-width="120px" :inline="true">
        ...
        <el-form-item label="位置：" class="marBottom7">
          <el-select   placeholder="请输入位置" :disabled="disabledBtn.createDis" clearable v-model="formItem.station" class="width200">
            <el-option
        ...
        <el-form-item label="单据状态：" class="marBottom7">
          <el-select placeholder="请输入单据状态" v-model="formItem.status" class="width200" clearable>
            <el-option
            ...
            <el-col :span="12">
              ...
              <el-form-item label="认证操作员：" class="star">
                <el-input
                  ...
                  maxlength="6"
                />
                <span class="isNotNull" maxlength="6" v-if="errorTip.userFlag">认证操作员不能为空</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              ...
              <el-form-item label="调入位置：">
                ...
                >
                  <el-option
                    ...
                    :key="index"
                    :label="item.LINE_LOCATION_NAME"
                    :value="item.LINE_LOCATION_NUMBER"
                  />
                </el-select>
    ...
    methods: {
      ...
      addListBtn() {
        ...
        if (_t.addEdit.inLocation !== '') {
          ...
          _t.alertDialogTip(_t, '请检查调入位置是否为空!');
        }
      ...
      addEditData() {
        ...
        if (_t.addList.length === 0) {
          ...
          if (isErrorNumber !== 0) {
            _t.disabledShow = false;
            _t.alertDialogTip(_t, "请检查上交数量是否为空、格式是否正确、且不能大于库存数量!");
          } else {
            // 可以提交
            if (
              _t.errorTip.userFlag === false &&
                ...
                item.mlcList.forEach(lts => {
                  if (lts.LINE_LOCATION_NUMBER == location) {
                    ...
                    if (lts.lineList && lts.lineList !== null) {
                      // 遍历线路
                      _t.stationListAll.push(lts);
                      lts.lineList.forEach(valStr => {
                        // _t.stationListAll.push(valStr)
