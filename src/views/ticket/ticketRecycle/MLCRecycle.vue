    ...
    <div class="dialog">
      ...
      >
        ...
        <el-form :model="addEdit" ref="addEdit" label-width="110px">
          <el-row :gutter="20">
            <el-col :span="12">
              ...
              <el-form-item label="调入位置：">
                <el-select disabled v-model="addEdit.outLocation" class="widthAll">
                  <el-option
                    clearable
                    v-for="(item,index) in linesListStation"
                    :key="index"
            ...
            <el-col :span="12">
              ...
              <el-form-item v-if="getCookie('LOCATION_TYPE_ID') == '23'" class="visibility" label="占位隐藏：">
                <el-input v-model="addEdit.inLocation"></el-input>
              </el-form-item>
              <el-form-item v-if="getCookie('LOCATION_TYPE_ID') !== '23'"  label="调出位置：">
                <el-select
                  clearable
          ...
          <el-row>
            <el-col>
              <el-form-item label="备注：" class="instof">
                <el-input
            ...
            <el-col :span="12">
              ...
              <el-form-item label="认证操作员：" class="star">
                <el-input
                  ...
                  @blur="ruleTicketInput(moneyFormItem.operatorUser,'operatorUser')"
                  placeholder="请输入操作员id"
                  maxlength="6"
                />
                <span class="isNotNull" v-if="moneyFormItemErr.operatorUser">必填项不能为空</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              ...
              <el-form-item label="密码：" class="star">
                <el-input
                  ...
                  @blur="ruleTicketInput(moneyFormItem.operatorPassword,'operatorPassword')"
                  type="password"
                  placeholder="请输入密码"
                  maxlength="6"
                />
                <span class="isNotNull" v-if="moneyFormItemErr.operatorPassword">必填项不能为空</span>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
        <el-table class="buttonBtn" border :data="ticketTypeNum" stripe>
        ...
        <el-form :model="detailFormItem" ref="detailFormItem" label-width="120px">
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              ...
              <el-form-item label="车票配送员ID：" class="marBottom7">
    ...
    methods: {
      ...
      createBtn() {
        ...
        if (
          ...
          if (_t.formItem.lines == 1) {
            _t.addEdit.station = location_number; // 车站
          } else if (_t.formItem.lines > 1) {
      ...
      addEditData() {
       ...
       var outInput = _t.addEdit.inLocation? _t.addEdit.inLocation: _t.addEdit.linesOutLocation;
        // 校验库存表格
              ...
              if (
                ...
                if (
                  ...
                  var params = {
                    ...
                    export_location_number: outInput, //调入位置
                    import_location_number: location_number, //调出位置
      ...
      addListBtn() {
        var _t = this;
        if ( _t.getCookie('LOCATION_TYPE_ID') !== '22') {
          if (_t.addEdit.linesOutLocation !=='') {
            _t.dialogAddVisible = true;
            _t.getTicketType();
          }else {
            _t.alertDialog('调入位置或调出线路不能为空!')
          }
        }else {
          if (_t.addEdit.inLocation !== '') {
            _t.dialogAddVisible = true;
            _t.getTicketType();
          }else {
            _t.alertDialog('调入位置或调出位置不能为空!')
          }
        }
      ...
      getTicketType() {
        var _t = this;
        var location_number = _t.addEdit.inLocation?_t.addEdit.inLocation: _t.addEdit.linesOutLocation;
        var user_id = _t.getCookie("USER_ID");
        if (
          location_number !== null &&
          location_number !== "null" &&
      ...
      ruleTicketInput(val, flag) {
        var _t = this;
        if (val.trim() === "") {
          _t.moneyFormItemErr[flag] = true;
        } else {
          _t.moneyFormItemErr[flag] = false;
        }
      },
      // 备票提交
      ticketCommit() {
        ...
        if (_t.moneyFormItem.operatorUser.trim() === "") {
          _t.moneyFormItemErr.operatorUser = true;
        } else {
          _t.moneyFormItemErr.operatorUser = false;
        }
        // 校验密码
        if (_t.moneyFormItem.operatorPassword.trim() === "") {
          _t.moneyFormItemErr.operatorPassword = true;
        } else {
          _t.moneyFormItemErr.operatorPassword = false;
        }
        // 校验实际备票数量
        if (_t.ticketTypeNum.length !== 0) {
          ...
          if (isErrorNum !== 0) {
            ...
            if (
              ...
              _t.$api.post("/tsGateWay/ticketTransfer/transferOrderPrepareTicketGateWay", params, function (res) {
                ...
                item.mlcList.forEach(lts => {
                  if (lts.LINE_LOCATION_NUMBER == location) {
                    ...
                    lts.lineList.forEach(vals => {
                      ...
                      LINE_LOCATION_NUMBER = location;
                      // vals.stationList.forEach(items => {
                      //   stationArr.push(items);
                      //
                      // });
                    });
                  } else {
