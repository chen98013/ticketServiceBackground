  ...
  <Box>
    <div class="formBox-top paddingBottom15">
      ...
      <div class="fr">
        ...
        <el-button type="warning" @click="resetFormItem">刷新</el-button>
      </div>
    </div>
    <div class="tableWp">
    ...
    methods: {
      ...
      editRole() {
        ...
        if (_t.detailFormItem.guid !== '') {
          ...
          _t.$api.post('/tsGateWay/systemManager/updateTicketAlarmParam', params, function (res) {
            if (res.rtCode && res.rtCode === '18054') {
    ...
    created() {
      ...
      if (limitMenuList !== null && limitMenuList.length !== 0) {
        ...
        limitBtnArr.forEach((item) => {
          // 查询
          if (item.MENU_ID === "MENU20191022133500RBqZmIxyehGbrc") {
            _t.limitBtn.query = true;
          }
          // 修改
          if (item.MENU_ID === "MENU20191022133359JSDTiTAMcMNTro") {
